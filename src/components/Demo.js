...
render()
{
    ...
    return(
        ...
        <View style = { styles.MainContainer }>
            ...
            <Text style={{textAlign: 'center'}}>this is my first react native splash screen  </Text>
            <Text style={{textAlign:'right'}}>welcome to our first react native application</Text>
